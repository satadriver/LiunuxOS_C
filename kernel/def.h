...
#define DYNAMIC_PRIORITY			(4*STATIC_PRIORITY)

#define AUTHORITY_PRIORITY			(2*STATIC_PRIORITY)

#define TASK_TIME_SLICE				10

#define TASK_SLICE_USER				3
#define TASK_SLICE_KERNEL			1
...
#define APICTIMER_FREQ				1000000000
...
#define CMOS_EXACT_TICK_COUNT 		(CMOS_PERIOD_TICK_COUNT + 4)	//512104
#define APICTIMER_TICK_COUNT		(CMOS_EXACT_TICK_COUNT + 4)		//512108
#define TIMER_TICK_COUNT			(APICTIMER_TICK_COUNT +TASK_LIMIT_TOTAL*4 )		//513132
#define SLEEP_TIMER_RECORD			(TIMER_TICK_COUNT + 4 )
...
#define MEMORY_ALLOC_BUFLIST			0X1600000
#define MEMORY_ALLOC_BUFLIST_SIZE		0X100000

#define PAGE_ALLOC_LIST					0X1700000
...
#define AP_TASK_TSS_ARRAY				0x1800000

#define BSP_HEAP_BASE					0X1c00000

#define BSP_FAST_HEAP					(BSP_HEAP_BASE + 0x100000)

#define KERNEL_STACK_BASE				0x1e00000
