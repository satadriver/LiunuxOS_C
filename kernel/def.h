...
#define DYNAMIC_PRIORITY			(2*STATIC_PRIORITY)

#define DEFAULT_PRIORITY			(STATIC_PRIORITY/2)
...
#define APICTIMER_TICK_COUNT		(CMOS_EXACT_TICK_COUNT + 4)
#define TIMER_TICK_COUNT			(APICTIMER_TICK_COUNT +TASK_LIMIT_TOTAL*4 )
