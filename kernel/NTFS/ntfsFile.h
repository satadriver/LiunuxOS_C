...
extern "C" __declspec(dllexport) unsigned long long getNtfsFileData(unsigned long long secoff,unsigned long long* filesize, char** buf);
...
extern "C" __declspec(dllimport) unsigned long long getNtfsFileData(unsigned long long secoff, unsigned long long *filesize,char** buf);
#endif
