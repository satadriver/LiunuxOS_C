...
extern "C" __declspec(dllexport) int __yield();
...
extern "C" __declspec(dllexport)int __leaveSpinlock(int* v);
extern "C" __declspec(dllexport)int __enterLock(int* lockvalue);
extern "C" __declspec(dllexport)int __leaveLock(int* lockvalue);
...
extern "C" __declspec(dllimport) double strlf2lf(char* str);

extern "C" __declspec(dllimport) int lf2strlf(double f, char* buf);
extern "C" __declspec(dllimport) int f2strf(float f, char* buf);

extern "C" __declspec(dllimport) int __i64ToStrd64(__int64 v, char* strd);
extern "C" __declspec(dllimport) int __i64ToStru64(__int64 v, char* buf);
...
extern "C" __declspec(dllimport) int __yield();
...
extern "C" __declspec(dllimport)int __leaveSpinlock(int* v);
extern "C"  __declspec(dllimport) int __spinlockEntry(int* lockv);

extern "C"  __declspec(dllimport) int __spinlockLeave(int* lockv);
